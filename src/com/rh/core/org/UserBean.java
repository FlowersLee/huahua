...
//        String[] deptArray = codePath.split(Constant.CODE_PATH_SEPERATOR);
     ...
     * @return 迪拜手机号
     */
    public String getMobileDubai() {
    	return this.getStr("USER_MOBILE_DUBAI");
    }
    ...
    public String getMobileIraq() {
    	return this.getStr("USER_MOBILE_IRAQ");
    }
    
    /**
     * @return 中国手机机号
     */
    public String getMobileChina() {
    	return this.getStr("USER_MOBILE_CHINA");
    }
    
    /**
     * @return 迪拜办公室电话
     */
    public String getOfficePhoneDubai() {
    	return this.getStr("USER_OFFICE_PHONE_DUBA");
    }
    ...
    public int getHrFlag() {
    	return this.getInt("USER_HR_FLAG");
    }
    ...
    public String getEnName() {
    	...
    	String userEnName = this.getStr("USER_EN_NAME");//获取英文名称
    	
    	if(StringUtils.isEmpty(userEnName)) {//如果英文名称为空，则根据中文名转换
    		userEnName = PinyinUtils.getPinyinStr(this.getName());
    	}
