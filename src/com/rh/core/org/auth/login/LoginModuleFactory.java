...
public class LoginModuleFactory {
    ...
    private static final String LOGIN_MODULE_AD = "com.rh.core.org.auth.login.ADPasswordLoginModule";
    ...
    public static LoginModule getLoginModule(String loginStyle, String loginModuleClass) {
        try {
            ...
            if ("AD".equals(loginStyle)) {
                return (LoginModule) Class.forName(LOGIN_MODULE_AD).newInstance();
            }
